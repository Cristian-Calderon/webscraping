...
# Tomar solo los primeros 10 héroes para prueba
...
for index, row in df_heroes.iterrows():
    ...
    try:
        ...
        # Filtrar datos correctos y evitar incluir velocidad de proyectil
...
csv_output = "dota2_heroes_details_prueba.csv"
